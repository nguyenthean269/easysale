...
export class CanHoChungCuChoThueComponent extends ApartmentListingBaseComponent {
  config: ApartmentListingConfig = {
    ...
    titleTemplates: {
      default: 'Căn hộ chung cư cho thuê',
      withPropertyGroup: 'Căn hộ chung cư cho thuê tại{propertyGroup}',
      withFilters: 'Căn hộ{unitType}{priceArea} cho thuê',
      withFiltersAndPropertyGroup: 'Căn hộ{unitType} cho thuê tại{propertyGroup}{priceArea}'
    },
    metaTitleTemplates: {
      default: 'Cho thuê căn hộ chung cư giá tốt | EasySale',
      withPropertyGroup: 'Cho thuê căn hộ chung cư tại{propertyGroup} | EasySale',
      withFilters: 'Căn hộ{unitType}{priceArea} cho thuê | EasySale',
      withFiltersAndPropertyGroup: 'Căn hộ{unitType} cho thuê tại{propertyGroup}{priceArea} | EasySale'
    },
    metaDescriptionTemplates: {
      default: 'Tìm kiếm và cho thuê căn hộ chung cư với giá tốt nhất. Danh sách căn hộ đầy đủ thông tin, cập nhật liên tục.',
      withPropertyGroup: 'Cho thuê căn hộ chung cư tại{propertyGroup}. Thông tin chi tiết, giá cả minh bạch, hỗ trợ tư vấn nhiệt tình.',
      withFilters: 'Tìm căn hộ{unitType}{priceArea} cho thuê. Danh sách căn hộ đầy đủ thông tin, giá tốt nhất thị trường.',
      withFiltersAndPropertyGroup: 'Thuê căn hộ{unitType} tại{propertyGroup}{priceArea}. Thông tin chi tiết, giá cả minh bạch, hỗ trợ xem nhà và tư vấn.'
    }
  };
  ...
  tableColumns: ApartmentTableColumn[] = [
    ...
    { key: 'rent_price', label: 'Giá thuê (VNĐ/tháng)', width: '180px' }
  ];
