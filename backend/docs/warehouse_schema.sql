...
CREATE TABLE `apartments` (
  ...
  `price` decimal(18,0) DEFAULT NULL COMMENT 'Giá niêm yết. Đơn vị VNĐ',
  `price_early` decimal(18,0) DEFAULT NULL COMMENT 'Giá thanh toán sớm. Đơn vị VNĐ',
  `price_schedule` decimal(18,0) DEFAULT NULL COMMENT 'Giá thanh toán theo tiến độ. Đơn vị VNĐ',
  `price_loan` decimal(18,0) DEFAULT NULL COMMENT 'Giá nếu vay ngân hàng. Đơn vị VNĐ',
  `price_rent` decimal(18,0) DEFAULT NULL COMMENT 'Giá thuê căn hộ trên tháng. Đơn vị VNĐ',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `phone_number` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Số điện thoại liên hệ',
  `furnished_status` enum('FULL','PARTIAL','UNFURNISHED') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Tình trạng nội thất: đầy đủ, một phần, không nội thất',
  `floor_level_category` enum('LOW','MEDIUM','HIGH') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Vị trí tầng: thấp, trung, cao',
  `move_in_ready` tinyint(1) DEFAULT NULL COMMENT 'Căn hộ sẵn sàng vào ở: 1=sẵn sàng, 0=chưa sẵn sàng, NULL=không rõ',
  `includes_transfer_fees` tinyint(1) DEFAULT NULL COMMENT 'Giá bao gồm phí chuyển nhượng: 1=có, 0=không, NULL=không rõ',
  `listing_type` enum('CAN_THUE','CAN_CHO_THUE','CAN_BAN','CAN_MUA','KHAC') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `data_status` enum('REVIEWING','PENDING','APPROVED') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PENDING' COMMENT 'Trạng thái của việc xử lý dữ liệu và nội dung',
  `unit_allocation` set('QUY_DOC_QUYEN','QUY_AN','QUY_CHEO','QUY_THUONG') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Loại quỹ căn: Quỹ độc quyền, Quỹ ẩn, Quỹ chéo, Quỹ thưởng',
  ...
  `time_created` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `property_groups` (
  ...
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Đường dẫn',
